...
INSERT INTO product(id, name, description, price, stock) VALUES (1, 'TONSTAD', 'Seed product TONSTAD', 199.00, 10);
INSERT INTO product(id, name, description, price, stock) VALUES (2, 'KALLAX', 'Seed product KALLAX', 89.00, 5);
INSERT INTO product(id, name, description, price, stock) VALUES (3, 'BESTÅ', 'Seed product BESTÅ', 149.00, 3);
